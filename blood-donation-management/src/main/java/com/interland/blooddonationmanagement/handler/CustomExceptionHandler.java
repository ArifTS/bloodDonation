package com.interland.blooddonationmanagement.handler;
...
import com.interland.blooddonationmanagement.dto.ServiceResponse;
import com.interland.blooddonationmanagement.exception.MessageParsingException;
import com.interland.blooddonationmanagement.exception.RecordCreateException;
import com.interland.blooddonationmanagement.exception.RecordNotFoundException;
import com.interland.blooddonationmanagement.exception.RecordUpdateException;
...
public class CustomExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public final ResponseEntity<Object> handleMessageParsingException(MessageParsingException ex, WebRequest request) {
		List<JSONObject> details = new ArrayList<>();
		ServiceResponse error = new ServiceResponse(ex.getMessage(),
				messageSource.getMessage(ex.getMessage(), null, LocaleContextHolder.getLocale()), details);
		return new ResponseEntity(error, HttpStatus.OK);
